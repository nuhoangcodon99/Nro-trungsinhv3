...
import com.girlkun.models.player.Referee2;
...
public class Manager {
    ...
    public static int MAX_PER_IP = 1;
    ...
    public static List<Item> DL = new ArrayList<>();
    ...
    public static final String queryTopGapThu = "SELECT id, CAST( point_gapthu AS UNSIGNED) AS p_thu FROM player ORDER BY CAST( point_gapthu AS UNSIGNED) DESC LIMIT 20";
    public static final String queryTopCauCa = "SELECT id, CAST( point_cauca AS UNSIGNED) AS cauca FROM player ORDER BY CAST( point_cauca AS UNSIGNED) DESC LIMIT 20";
    ...
    public static final String queryTopNV = "SELECT id, JSON_EXTRACT(data_task, '$[0]') AS second_value\n"
            + "						FROM player\n"
    ...
    public static final String queryTopNHS = "SELECT id, CAST( NguHanhSonPoint AS UNSIGNED) AS NguHanhSonPoin FROM player ORDER BY CAST( NguHanhSonPoint AS UNSIGNED) DESC LIMIT 20";
    public static final String queryTopCS = "SELECT id, CAST( chuyenSinh AS UNSIGNED) AS chuyenSinh FROM player ORDER BY CAST( chuyenSinh AS UNSIGNED) DESC LIMIT 50;";
    ...
    public static final String queryTopNap = "SELECT p.id, a.tongnap\n"
            ...
            + "LIMIT 20;";
    public static final String queryTopLeoThap = "SELECT id, CAST( capboss AS UNSIGNED) AS leothap FROM player ORDER BY CAST( capboss AS UNSIGNED) DESC LIMIT 20";
    ...
    public static List<TOP> TopGapThu;
...
//                    dataArray.clear();
            ...
            Logger.success("Load top sức mạnh thành công (" + topSM.size() + ")\n");
            ...
            Logger.success("Load Top Ngũ Hành Sơn Thành Công (" + topNHS.size() + ")\n");
            ...
            Logger.success("Load Top Câu Cá Thành Công (" + TopCauCa.size() + ")\n");
            TopLeoThap = realTop(queryTopLeoThap, con);
            Logger.success("Load top Leo Tháp thành công (" + TopLeoThap.size() + ")\n");
            ...
            while (rs.next()) {
                ...
                switch (query) {
                    ...
                    case queryTopCS:
                        ...
                        break;
                    case queryTopGapThu:
                        top.setInfo1(rs.getInt("p_thu") + " lần gắp");
                        top.setInfo2(rs.getInt("p_thu") + " lần gắp");
                        break;
                    case queryTopLeoThap:
                        top.setInfo1(rs.getInt("leothap") + " tầng");
                        top.setInfo2(rs.getInt("leothap") + " tầng");
                        break;
                    case queryTopCauCa:
                        top.setInfo1(rs.getInt("cauca") + " điểm");
                        top.setInfo2(rs.getInt("cauca") + " điểm");
                        break;
                    case queryTopSD:
