...
public class NauBanh implements Runnable {
    ...
    public void run() {
        while (true) {
            try {
                if (ThoiGianCho != 0 && Util.canDoWithTime(ThoiGianCho, 1000))ThoiGianCho = 0;
                if (ThoiGianNau != 0 && Util.canDoWithTime(ThoiGianNau, 1000))ThoiGianNau = 0;
                if (ThoiGianChoLayBanh != 0 && Util.canDoWithTime(ThoiGianChoLayBanh, 1000))ThoiGianChoLayBanh = 0;
                if (Cui >= 1 && Nuoc >= 1) {
