...
//    private static final long DEFAULT_TIME_DONE = 7776000000L;
    ...
    public cr4(Player player, long lastTimeCreate, long timeDone) {
        this.player = player;
        this.lastTimeCreate = lastTimeCreate;
        this.timeDone = timeDone;
    }

    public static void createcr4(Player player) {
        player.cr4 = new cr4(player, System.currentTimeMillis(), DEFAULT_TIME_DONE);
    }
