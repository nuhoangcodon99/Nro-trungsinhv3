...
//    private static final long DEFAULT_TIME_DONE = 7776000000L;
    ...
    public cr2(Player player, long lastTimeCreate, long timeDone) {
        this.player = player;
        this.lastTimeCreate = lastTimeCreate;
        this.timeDone = timeDone;
    }

    public static void createcr2(Player player) {
        player.cr2 = new cr2(player, System.currentTimeMillis(), DEFAULT_TIME_DONE);
    }
