...
//
//    public carotegg(Player player, long lastTimeCreate, long timeDone) {
//        this.player = player;
//        this.lastTimeCreate = lastTimeCreate;
//        this.timeDone = timeDone;
//    }
//
//    public static void createcarotegg(Player player) {
//        player.carotegg = new carotegg(player, System.currentTimeMillis(), DEFAULT_TIME_DONE);
//    }
//
//    public void sendcarotegg() {
//        Message msg;
//        try {
...
//            msg.writer().writeShort(26446);
//            msg.writer().writeByte(0);
//            msg.writer().writeInt(this.getSecondDone());
//            this.player.sendMessage(msg);
//            msg.cleanup();
//        } catch (Exception e) {
//            Logger.logException(carotegg.class, e);
//        }
//    }
//
