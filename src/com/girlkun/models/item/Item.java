...
public class Item {
    ...
    public boolean isTrangBiHSD() {
        return InventoryServiceNew.gI().hasOptionTemplateId(this, 77);
    }
     public boolean isTrangBiGIAP() {
        return InventoryServiceNew.gI().hasOptionTemplateId(this, 5);
    }
      public boolean isTrangBiHP() {
        return InventoryServiceNew.gI().hasOptionTemplateId(this, 77);
    }
       public boolean isTrangBiSD() {
        return InventoryServiceNew.gI().hasOptionTemplateId(this, 50);
    }
        public boolean isTrangBiKI() {
        return InventoryServiceNew.gI().hasOptionTemplateId(this, 103);
    }
    ...
    public boolean isManhTS() {
     ...
     public boolean ismanhthanlinh() {
        if (this.template.id >= 1520 && this.template.id <= 1524) {
            return true;
        }
        return false;
    }
