...
//            Logger.logException(MapService.class, e);
        ...
        if (!plInfo.isBoss && !plInfo.isPet && !plInfo.isNewPet && !(plInfo instanceof BossDHVT)&& !(plInfo instanceof Referee2) && !(plInfo instanceof Referee) && !(plInfo instanceof BossVD) && !(plInfo instanceof Referee1)) {
