...
/**
 * @author Ánh Ngọc Zalo0343214443
 */
public class MartialCongressServices {

    private static MartialCongressServices i;

    public static MartialCongressServices gI() {
        if (i == null) {
            i = new MartialCongressServices();
        }
        return i;
    }
    ...
    public void startChallenge(Player player) {
        ...
        if (zone != null) {
            ...
            Util.setTimeout(() -> {
                MartialCongresse mc = new MartialCongresse();
                mc.setPlayer(player);
                mc.setNpc(zone.getReferee1());
                mc.toTheNextRound();
                MartialCongressManagere.gI().add(mc);
