...
public class NPoint {
    ...
    public boolean khangTM;
     public boolean isxuong; //Cải trang xương khô
    public boolean iscarot; //Cải trang thỏ đại ca
     public boolean iscarott; //boss thỏ đại ca
    public boolean ismabu; // Biến socola
    public int istm; //Ru ngủ
     public int giamsd; //giamr sức đánh mob
...
//            tlNeDon += RewardBlackBall.R6S_2;
                ...
                for (Item.ItemOption io : item.itemOptions) {
                    switch (io.optionTemplate.id) {
                        ...
                        case 109: //Hôi, giảm #% HP
                            ...
                            break;
                            case 114: //Hôi, giảm #% HP
                            this.giamhp += io.param;
                            break;
    ...
    private void setHpMax() {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 2// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.hpMax += ((long) this.hpMax * 80 / 100);//chi so hp
        }
        if (this.player.isPet && ((Pet) this.player).typePet == 2// chi so lam sao bac tu cho dj
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.hpMax += ((long) this.hpMax * 90 / 100);//chi so hp
        }
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.hpMax += ((long) this.hpMax * 90 / 100);
        }
        if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.hpMax += ((long) this.hpMax * 100 / 100);
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.hpMax += ((long) this.hpMax * 110 / 100);
        }
        ...
        //}
         //danh hiệu
        if (this.player.isTitleUse1 == true) {
            this.hpMax += ((double) this.hpMax * 5 / 100);
        }
        if (this.player.isTitleUse2 == true) {
            this.hpMax += ((double) this.hpMax * 5 / 100);
        }
        if (this.player.isTitleUse3 == true) {
            this.hpMax += ((double) this.hpMax * 5 / 100);
        }
        if (this.player.isTitleUse4 == true) {
            this.hpMax += ((double) this.hpMax * 5 / 100);
        }
        //phù
...
//        }
    ...
    private void setMpMax() {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 1
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.mpMax += ((long) this.mpMax * 60 / 100);
        }
        if (this.player.isPet && ((Pet) this.player).typePet == 1
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.mpMax += ((long) this.mpMax * 70 / 100);//MP berus
        }
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.mpMax += ((long) this.mpMax * 80 / 100);//MP berus
        }
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.mpMax += ((long) this.mpMax * 90 / 100);//MP berus
        }
        //ditnhau
        if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA2) {
            this.mpMax += ((long) this.mpMax * 90 / 100);
        }
        if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.mpMax += ((long) this.mpMax * 100 / 100);
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.mpMax += ((long) this.mpMax * 110 / 100);
...
//        }
    ...
    private void setDame() {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            this.dame += ((long) this.dame * 80 / 100);
        }
        if (this.player.isPet && ((Pet) this.player).typePet == 2
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.dame += ((long) this.dame * 90 / 100);
        }
        //ditnhau
        if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
        ...
        if (this.player.isPet && ((Pet) this.player).typePet == 3
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA4) {
            this.dame += ((long) this.dame * 110 / 100);
        }
...
//        }
    ...
    private void resetPoint() {
        ...
        this.iscarot = false; //Cải trang Thỏ đại ca
        this.iscarott = false; //Cải trang Thỏ đại ca
         this.isxuong = false; //Cải trang Thỏ đại ca
         this.ismabu = false; //Cải trang Thỏ đại ca
        this.istm = 0; //Cải trang Thỏ đại ca
        this.hpAdd = 0;
        this.giamsd = 0;
        this.mpAdd = 0;
        this.dameAdd = 0;
    ...
    public long calSucManhTiemNang(long tiemNang) {
        if (power < getPowerLimit()) {
            ...
            if (this.player.charms.tdTriTue4 > System.currentTimeMillis()) {
             ...
             this.tltnsm += ((long) this.hpMax  / 100);
