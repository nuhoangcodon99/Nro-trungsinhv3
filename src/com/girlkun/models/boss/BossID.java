...
public class BossID {
    ...
    public static final int KUKU = -20;
     public static final int DETU = -3838;
    public static final int MAP_DAU_DINH = -21;
    public static final int RAMBO = -22;
    public static final int DUONG_TANG_HOTONG = -222333;
     public static final int SAIBAMEN = -248;
     public static final int MI_NUONG1 = -111;
    public static final int MI_NUONG2 = -112;
    public static final int MI_NUONG3 = -113;
    //tiểu đội bojack
    public static final int SPBOJACK = -222333;
    public static final int KOGU = -2233;
    public static final int BIDO = -1232;
    public static final int ZANG = -22332;
    public static final int BOJACK = -7778;
    ...
    public static final int s1 = -22333;
    public static final int s2 = -22233;
    public static final int s3 = -1233;
    public static final int s4 = -2332;
    public static final int tdt = -778;
//   
    ...
    public static final int THODAICA = -10293;
    public static final int TIEU_DOI_TRUONG = -27;
    public static final int MABU_1 = -28888;
    public static final int BE = -29999;
    ...
    public static final int MI_NUONG_HOTONG = 8722;
    ...
    public static final int BROLY = -214;
    ...
    public static  final int SON_TINH = -722;
    public static  final int THUY_TINH = -7373;
    ...
    public static final int SONTINH = -999;
    public static final int THUYTINHH = -998;
    ...
    public static final int XUVIP = - 424;
    public static final int XUCAOCAP = - 4245;
    public static final int XUTHUONG = - 4242;
