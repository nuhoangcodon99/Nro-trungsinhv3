...
public class ConstNpc {
    ...
    public static final String TRONGDUAHAU = "|7|Thêm Đủ Nước Và Phân Bón Để Bắt Đầu Trồng\n"
            ...
            + "|7|1 Hạt Giống, 1 Bình Nước, 1 Phân Bón";
    ...
    public static final byte minuong = 84;
    ...
    public static final byte VODAI = 102;
    public static final byte Granola = 96;
    public static final byte VIHOP = 78;
    public static final byte RONG_BANG = 79;
    public static final byte CHOPPER = 108;
    public static final byte FRANKY = 109;
    public static final byte NAMI = 105;
    public static final byte BILL_BI_NGO = 85;
    
    public static final byte ONG_GIA_NOEL = 98;
    public static final byte cr2 = 90;
    public static final byte KAI_DO = 93;
    public static final byte GAPTHU = 81;
    public static final byte GAPTHU1 = 82;
    public static final byte TEST = 80;
    public static final byte ADMIN = 83;
    public static final byte MINUONG = 84;
    public static final byte CAYTHONG = 99;
    public static final byte CANCAU = 79;
    public static final byte RONG_XUONG = 105;
    public static final byte cr1 = 89;
    public static final byte CAYCHUOI = 81;
    public static final byte cr3 = 91;
    public static final byte KA = 87;
    public static final byte HAHA = 92;
    public static final byte DUAHAU = 88;
    ...
    public static final int MENU_OPEN_DBKB = 550;
     public static final int QUY_LAO = 5570;
    ...
    public static final int  MENU_OPENED_DOANH_TRAI = 7272;
...
public static final int NANGCAITRANG = 5408;
    ...
    public static final int MENU_NANG_BONGTAI = 5999;
    public static final int HOTRO = 5899;
public static final int MIEN_PHI = 58998;
public static final int INFO = 5898;
public static final int MENU_PLAYER = 58898;
public static final int CHISO_NHANH = 58198;
    ...
    public static final int HOI_SKILL = 50876;
    ...
    public static final int MENU_TRAIN_OFFLINE = 503;
    public static final int MENU_TRAIN_OFFLINE_TRY0 = 504;
    public static final int MENU_TRAIN_OFFLINE_TRY1 = 505;
    public static final int HOISINH = 528;
    public static int MENU_DHVT = 560;
    public static int BKTTT = 565;
}
