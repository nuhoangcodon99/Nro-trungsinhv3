 ...
 public boolean hasOptionTemplateId(Item item, int optionTemplateId) {
    ...
    public void itemBagToBody(Player player, int index) {
        ...
        if (item.isNotNullItem()) {
            ...
            if (item.template.type == 5 || item.template.type == 74 ) {
    ...
    public void itemBodyToBag(Player player, int index) {
        ...
        if (item.isNotNullItem()) {
            ...
            Service.gI().sendFoott(player, item.template.part);
            ...
            Service.getInstance().Send_Caitrang(player);
            Service.getInstance().point(player);
            if (item.template.type == 5 || item.template.type == 73 || item.template.type == 37 || item.template.type == 38 || item.template.type == 102) {
...
//                Service.gI().sendTitle(player, item.template.part);
    ...
    public void itemBagToPetBody(Player player, int index) {
        Item item = player.inventory.itemsBag.get(index);
        if (player.pet != null && player.pet.nPoint.power >= 1500000 && item.template.id != 691 && item.template.id != 692 && item.template.id != 693) {
