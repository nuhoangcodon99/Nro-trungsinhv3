...
//            Logger.logException(UseItem.class, e);
        ...
        if (item.template.strRequire <= pl.nPoint.power) {
            switch (item.template.type) {
                case 74:
                    ...
                    break;
                case 73:
                    InventoryServiceNew.gI().itemBodyToBag(pl, indexBag);
                    Service.gI().sendFoott(pl, item.template.id);
                    break;
                case 21:
                    if (pl.newpet != null) {
                ...
                default:
                    switch (item.template.id) {
                        ...
                        case 1105://hop qua skh, item 2002 xd
                            ...
                            break;
                        case 915:
                            pl.inventory.ruby += Util.nextInt(50, 1000);
                            break;
                        case 1434:
                            hoppet(pl, item);
                            break;
                        ...
                        case 1419:
                            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                            Service.gI().sendThongBao(pl, "Đang Câu Cá");
                            int time = 5000;
                            if (pl != null) {
                        ...
                        case 1420:
                            ...
                            if (pl != null) {
                                EffectSkillService.gI().setBlindDCTT(pl, System.currentTimeMillis(), time);
                                EffectSkillService.gI().sendEffectPlayer(pl, pl, EffectSkillService.TURN_ON_EFFECT, EffectSkillService.CAROT);
                        ...
                        case 2027:
                            case 1518: 
                            pl.clan.haveGoneDoanhTrai2 = false;
                            pl.clan.doanhTrai2 = null;
                                InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                                                InventoryServiceNew.gI().sendItemBags(pl);
                            break;
                        case 2028: {
    ...
    private void usePorata(Player pl) {
        ...
        Item get5 = InventoryServiceNew.gI().findItem(pl.inventory.itemsBody, 1320);
        Item get6 = InventoryServiceNew.gI().findItem(pl.inventory.itemsBody, 1322);
        Item pet5 = InventoryServiceNew.gI().findItem(pl.pet.inventory.itemsBody, 1320);
        Item pet6 = InventoryServiceNew.gI().findItem(pl.pet.inventory.itemsBody, 1322);
        if (pet6 != null && pl.fusion.typeFusion == ConstPlayer.NON_FUSION && get5 != null || pet5 != null && get6 != null && pl.fusion.typeFusion == ConstPlayer.NON_FUSION) {
            pl.pet.ggtv4(true);
