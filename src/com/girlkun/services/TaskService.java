...
//                    break; 
     ...
     *
     * @param player
     * @param boss check boss nhiem vu cho player
     */
...
//        }
    ...
    public void paySideTask1(Player player) {
        if (player.playerTask.sideTask.template != null) {
            if (player.playerTask.sideTask.isDone()) {
                int item = 0;
                ...
                switch (player.playerTask.sideTask.level) {
                    case ConstTask.EASY:
                        item = ConstTask.GOLD_EASY;
                        break;
                    case ConstTask.NORMAL:
                        item = ConstTask.GOLD_NORMAL;
                        break;
                    case ConstTask.HARD:
                        item = ConstTask.GOLD_HARD;
                        break;
                    case ConstTask.VERY_HARD:
                        item = ConstTask.GOLD_VERY_HARD;
                        break;
                    case ConstTask.HELL:
                        item = ConstTask.GOLD_HELL;
                        break;
                }
                Item itemToReceive = null;
                switch (player.playerTask.sideTask.level) {
                    case ConstTask.EASY:
                        itemToReceive = ItemService.gI().createNewItem((short) 457);
                        break;
                    case ConstTask.NORMAL:
                        itemToReceive = ItemService.gI().createNewItem((short) 458);
                        break;
                    case ConstTask.HARD:
                        itemToReceive = ItemService.gI().createNewItem((short) 459);
                        break;
                    case ConstTask.VERY_HARD:
                        itemToReceive = ItemService.gI().createNewItem((short) 410);
                        break;
                    case ConstTask.HELL:
                        itemToReceive = ItemService.gI().createNewItem((short) 423);
                        break;
                }

                if (itemToReceive != null) {
                    itemToReceive.quantity = item;
                    itemToReceive.itemOptions.add(new Item.ItemOption(30, 1));
                    InventoryServiceNew.gI().addItemBag(player, itemToReceive);
    ...
    private void addItemBag(Player player, int goldReward) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private static class plKill {
